<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="UI.Products.List" %>
            ...
            <HeaderTemplate>
                <table border="1" cellspacing="0" style="width:910px;border:dashed">                  
                    <tr  style="height:50px">
                        ...
                        <td class="auto-style1">所属种类</td>
                        <td class="auto-style1">实际库存</td>
                        <td class="auto-style1">虚拟库存</td>
             ...
             <tr style="height:35px">
                ...
                <td align="center"><%# Eval("ProductName") %></td> 
                 ...
                 <td align="center"><%# Eval("Num") %></td>   
                 <td align="center"><%# Eval("ProductPrice") %></td>                                                                                                                                         
                 <td align="center">
                     <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "ProductAdd.aspx?id="+Eval("ProductID") %>' runat="server">编辑</asp:HyperLink>
                     <asp:LinkButton ID="LinkButton1" CommandName="delete" CommandArgument='<%# Eval("ProductID") %>' runat="server">删除</asp:LinkButton>
                 </td>
            </tr>
            </ItemTemplate>
